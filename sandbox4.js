...
speak('mario,tiro');//se le da valor al time y al name
speak();//como no se le da valor solo pone los predeterminados
speak('golpe, fred');
//funcion regular
const calcArea1 = function(radius1){
    ...
    //return area1;
    //console.log(area1); // sirve para llamar el resultado en la consola
}
//calcArea1(5); //solo para cuando este este nada mas el otro en la funcion
...
people.forEach((person,index)=>{//index sirve para dar un indice
